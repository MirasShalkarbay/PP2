...
class Player(pygame.sprite.Sprite):
    ...
    def update(self, score):
        ...
        if pygame.sprite.spritecollide(self, cars, False): #Проверка на столкновение с машинами
            fail = True
        if pygame.sprite.spritecollide(self, coins, False): #Проверка на столкновение с монетками
